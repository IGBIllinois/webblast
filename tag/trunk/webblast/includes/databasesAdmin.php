...
{
        $uploadsDirectory=getcwd()."/uploads/";
        $querySubmitDataBase="INSERT INTO dbs (dbname,type,description,userid,active,userid,active) VALUES (\"".$_POST['dbName']."\",\"".$_POST['dbType']."\",\"".$_POST['dbDescription']."\",".$_POST['userid'].",1)";
        $sqlDataBase->nonSelectQuery($querySubmitDataBase);
}
