...
<li class="tab-current"><a class="progLinks" id="blastnTab" href="index.php?PROGRAMS=megaBlast" title="Search a nucleotide databases using a nucleotide query">blastn</a></li>
<li class="tab-rh">&nbsp</li>
<li><a class="progLinks" id="blastpTab" href="index.php?PROGRAM=blastp" title="Search a protein databases using a protein query">blastp</a></li>
<li class="tab ">&nbsp</li>
<li><a  class="progLinks" id="blastxTab" href="index.php?PROGRAM=blastx" title="Search protein databases using a translated nucleotide query">blastx</a></li>                
<li class="tab ">&nbsp</li> 
<li><a class="progLinks" id="tblastnTab" href="index.php?PROGRAM=tblastn" title="Search translated nucleotide database using a protein query">tblastn</a></li>                
<li class="tab ">&nbsp</li> 
<li><a class="progLinks" id="tblastxTab" href="index.php?PROGRAM=tblastx" title="Search translated nucleotide database using a translated nucleotide query">tblastx</a></li> 
<li class="tab ">&nbsp</li> 
        ...
        <form name="searchForm" action="http://blast.ncbi.nlm.nih.gov/Blast.cgi" enctype="multipart/form-data"  method="post" class="f-wrap-1 all" id="searchForm">
         <div id="progDescr">BLASTN programs search nucleotide databases using a nucleotide query.
         <a href="http://www.ncbi.nlm.nih.gov/blast/producttable.shtml#mega" id="progHelp" title="help" target="helpWin" class="help ">more...</a>
   ...
   <fieldset>
      ...
      <div class="qs">
         <div class="formblock all" id="qseq">
            ...
            <input type="hidden" id="db" value="nucleotide" name="db"/>
         </div>   
   ...
   <fieldset>
      ...
      <div class="qs">
         <div class="formblock all" id="sseq">
            ...
            <!-- This of course would have to change with selected program -->
            <input type="hidden" id="stype" value="nucleotide" name="stype"/>
            <br />            
         </div>   
...
-->
  ...
  <fieldset>
    ...
    <div class="input all">    
      <div class="blastn megaBlast discoMegablast" id="genomeDbs">  
      <input id="Rhc" name="DBTYPE" type="radio" value="hc"  checked="checked" />
      <label for="Rhc" class="cbr">Human genomic + transcript</label>
      <input id="Rmc" name="DBTYPE" type="radio" value="mc"  />
      <label for="Rmc" class="cbr">Mouse genomic + transcript</label>
      <input id="Rgen" name="DBTYPE" type="radio" value="gc"  />
      <label for="Rgen" class="cbr">Others (nr etc.):</label>
</div>
      
      <div class="all dbdata">      
      <select name="DATABASE" id="DATABASE" class="reset checkDef" defVal="dbindex/9606/allcontig_and_rna">
<optgroup label="Genomic plus Transcript">
<option id="Ohc" value="dbindex/9606/allcontig_and_rna"  >Human genomic plus transcript (Human G+T)</option>
<option id="Omc" value="dbindex/10090/allcontig_and_rna"  >Mouse genomic plus transcript (Mouse G+T)</option>
</optgroup>
<optgroup label="Other Databases">
<!-- blastn, megablast, discomegablast, tblastn, tblastx -->    
<option value="nr" id="Ogen"  >Nucleotide collection (nr/nt)</option>        
...
<option value="chromosome"  >NCBI Genomes (chromosome)</option>
...
<a href="http://www.ncbi.nlm.nih.gov/BLAST/blastcgihelp.shtml#nucleotide_databases" target="helpWin" >more...</a>      
      </div>      
    </div>
    </div>
...
<div class="all megaBlast" id="optSection">
...
-->
  ...
  <fieldset id="progSel" class="blastp psiBlast phiBlast blastn megaBlast discoMegablast">
    ...
    <tr><td>      
      ...
      <input name="BLAST_PROGRAMS" id="megaBlast" type="radio" value="megaBlast" checked="checked" />
   ...
   <table>
      <tr><td>      
      <!-- onclick= SetProgTypeDefaults() - adjust lists on the page corresponding to the program -->
      <input name="BLAST_PROGRAMS" id="blastp" type="radio" value="blastp"  />
   ...
   <div class="searchInfo all">        
     ...
     <div class="searchsummary">
         <div class="openNewWin all">
            ...
            <span class="progInfo">Megablast</span>    
            <span class="progDescr">(Optimize for highly similar sequences) </span>                      
            <br />
   ...
   <div id="moreopts" toggle="toggleOptions"  class="hidden"> 
     ...
     <fieldset class="all section">
         ...
         <div class="input all">
            <select name="WORD_SIZE" id="wordsize" class="reset checkDef opts" defVal="28" ><option value="16"  >16</option>
...
<option value="256"  >256</option></select>            
      ...
      <fieldset class="blastp psiBlast phiBlast blastx tblastx tblastn blastn megaBlast discoMegablast">
         ...
         <div class="input blastp psiBlast phiBlast blastx tblastx tblastn">               
            ...
            <select name="MATRIX_NAME" id="matrixName" class="reset checkDef opts" defVal="">
         ...
         <div class="input blastn megaBlast discoMegablast">
            <select name="MATCH_SCORES" id="matchscores" class="reset checkDef opts" defVal="1,-2"> 
         ...
         <div class="input blastp psiBlast phiBlast blastx tblastn blastn megaBlast discoMegablast">
            <select name="GAPCOSTS" id="gapcosts" class="reset checkDef opts" defVal="0 0" ><!-- default depends on MatchScores selected - doen in javascript -->
            <option value = "0 0" class="only megaBlast"  >Linear</option>   
<option value = "5 2" class="Deflt"  >Existence:  5 Extension: 2</option>				
...
<option value = "1 1"  >Existence: 1 Extension: 1</option>				                                
         ...
         <div class="input blastp psiBlast tblastn">
            <select name="COMPOSITION_BASED_STATISTICS" id="compbasedstat" class="reset checkDef opts" defVal="">
      ...
      <fieldset class="all section">
         ...
         <!-- <div class="input all"> -->
         <div class="input all">
               <div class="all"><input type="checkbox" name="FILTER" value="L" id="fil_l"  class="reset checkDef opts" defVal="checked"/>
               ...
               <input type="checkbox" name="FILTER" value="R" id="fil_r"  class="reset checkDef opts" defVal="unchecked" /><!-- default depends on database selected - done in JS -->
         ...
         <!-- <div class="input all"> -->
         <div class="input all">
               <div class="all"><input type="checkbox" name="FILTER" value="m" id="fil_m" checked="checked" class="reset checkDef opts" defVal="checked" />
...
<input class="reset" name="NEW_VIEW" id="NEW_VIEW" type="hidden" value="on" defVal="true"/>
...
<input name="PAGE" type="hidden" id="page" value="MegaBlast"/>
<input name="PROGRAM" type="hidden" value="blastn" id="program" />
<input name="MEGABLAST" type="hidden" id="runMegablast" value="on" />
...
<input type="hidden" id="megaBlastProg" value="Megablast" />
<input type="hidden" id="megaBlastDescr" value="(Optimize for highly similar sequences)" />
<input type="hidden" id="discoMegablastProg" value="Discontiguous megablast" />
<input type="hidden" id="discoMegablastDescr" value="(Optimize for more dissimilar sequences )" />
<input type="hidden" id="blastnProg" value="Blastn" />
<input type="hidden" id="blastnDescr" value="(Optimize for somewhat similar sequences)" />
<input name="DEFAULT_PROG" type="hidden" value="megaBlast" id="defaultProg" />
<input id="blastType" name="WWW_BLAST_TYPE" type="hidden" value="mapview" />

<input type="hidden" id="OhcAbbr" value="Human G+T" />
<input type="hidden" id="OmcAbbr" value="Mouse G+T" />
<input type="hidden" id="dbAbbr" name="DB_ABBR" value="Human G+T" />
...
<input name="SELECTED_PROG_TYPE" id="selectedProg" type="hidden" value="megaBlast"/>
...
<div id="savedLists">
<select id="wordsize_blastn"><option value="7"  >7</option>
<option value="11" class="Deflt"   >11</option>
<option value="15"  >15</option></select>
<select id="wordsize_megaBlast"><option value="16"  >16</option>
<option value="20"  >20</option>
<option value="24"  >24</option>
<option value="28" class="Deflt" selected="selected" >28</option>
<option value="32"  >32</option>
...
<option value="128"  >128</option>
<option value="256"  >256</option></select>
<select id="wordsize_discoMegablast"><option value="11" class="Deflt"  >11</option>
<option value="12"  >12</option></select>
<select id="gapcosts_1-2"><option value = "0 0" class="only megaBlast"  >Linear</option>   
<option value = "5 2" class="Deflt"  >Existence:  5 Extension: 2</option>				
<option value = "2 2"  >Existence:  2 Extension: 2</option>				
<option value = "1 2"  >Existence:  1 Extension: 2</option>
<option value = "0 2"  >Existence:  0 Extension: 2</option>
<option value = "3 1"  >Existence:  3 Extension: 1</option>		
<option value = "2 1"  >Existence:  2 Extension: 1</option>		
<option value = "1 1"  >Existence: 1 Extension: 1</option>				</select>
<select id="gapcosts_1-3"><option value = "0 0" class="only megaBlast"  >Linear</option>   
<option value = "5 2" class="Deflt"  >Existence:  5 Extension: 2</option>				
<option value = "2 2"  >Existence:  2 Extension: 2</option>		
<option value = "1 2"  >Existence:  1 Extension: 2</option>		
<option value = "0 2"  >Existence:  0 Extension: 2</option>		
<option value = "2 1"  >Existence:  2 Extension: 1</option>		
<option value = "1 1"  >Existence: 1 Extension: 1</option>	</select>
<select id="gapcosts_1-4"><option value = "0 0" class="only megaBlast"  >Linear</option>   
<option value = "5 2" class="Deflt"  >Existence:  5 Extension: 2</option>					
<option value = "1 2"  >Existence:  1 Extension: 2</option>		
<option value = "0 2"  >Existence:  0 Extension: 2</option>		
<option value = "2 1"  >Existence:  2 Extension: 1</option>		
<option value = "1 1"  >Existence: 1 Extension: 1</option>	</select>
<select id="gapcosts_2-3"><option value = "0 0" class="only megaBlast"  >Linear</option>   
...
<option value = "2 2"  >Existence:  2 Extension: 2</option>				</select>
<select id="gapcosts_4-5"><option value = "0 0" class="only megaBlast"  >Linear</option>   
<option value = "12 8" class="Deflt"  >Existence:  12 Extension: 8</option>		
...
<option value = "3 5"  >Existence:  3 Extension: 5</option>	</select>
<select id="gapcosts_1-1"><option value = "5 2" class="Deflt"  >Existence:  5 Extension: 2</option>						
...
<option value = "3 1"  >Existence:  3 Extension: 1</option>		
<option value = "2 1"  >Existence:  2 Extension: 1</option>		</select>
<input name="USER_DEFAULT_PROG_TYPE" id="userDefaultprog" type="hidden" value="megaBlast"/>
<input name="USER_DEFAULT_MATCH_SCORES" id="userDefaultMatchScores" type="hidden" value=""/>
</div>
</form>
</div><!--/#content-->
