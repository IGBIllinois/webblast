...
my $file = shift or die "Usage: renderBlast.pl <blast file> QueryNumber \n";
my $queryNumber = shift or die "Usage: renderBlast.pl <blast file> QueryNumber \n"; 
...
{
	$result = $searchio->next_result() or die "no result";
}
