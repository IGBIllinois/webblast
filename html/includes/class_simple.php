...
?>
<br>
<b><font color="blue">This form is used exclusively for teaching purposes</font></b>
<br><br>
<FORM ACTION="index.php" METHOD="POST" NAME="MainBlastFormSimple"
	...
	<table>
		...
		<tr>
			...
			<td><select name="chunkSize" id="chunkSize">
			<?php
		...
		<tr>
			...
			<td><select name="inputd" id="d" size="0">
					<option value=8 SELECTED>nt</option>
			</select>
			</td>
		...
		<tr>
                        ...
                        <td>Fasta formatted query file to use (-i)</td>
                </tr>
		<tr>
	...
	<table>
		...
		<tr>
			<td><input type="checkbox" name="params[]" id="TU_box" value="TU" checked>
			</td>
			<td>T</td>
