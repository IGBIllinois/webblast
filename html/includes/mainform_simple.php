...
<FORM ACTION="index.php" METHOD="POST" NAME="MainBlastFormSimple"
	...
	<table class='table table-striped'>
		...
		<tr>
			...
			<td><SELECT class='form-control' name="profile" OnChange="OnSelectProfile(this)">
		...
		<tr>
			...
			<td><input class='form-control' type="text" name="saveProfileName"><input class='btn btn-primary' type="submit"
		...
		<tr>
			...
			<td><select class='form-control' name="chunkSize" id="chunkSize">
			<?php
		...
		<tr>
			...
			<td><select class='form-control' name="inputp" id="p" size="0"
		...
		<tr>
			...
			<td><select class='form-control' name="inputd" id="d" size="0">
		...
		<tr>
			...
			<td><input type="hidden" name="MAX_FILE_SIZE" value="1610612736" /> <INPUT class='form-control'
		...
		<tr>
			<td></td>
			<td colspan="3">
			<INPUT class='btn btn-primary' TYPE="submit" VALUE="Submit Blast Search" name="submitfasta"> 
			<INPUT class='btn btn-warning' TYPE="reset" VALUE="Reset Inputs">
			</td>
		</tr>
	</table>
	<br> <br>
