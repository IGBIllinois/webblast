<?php
/*
Configuration for webblast
SQL authentication information
*/
$sqlUserName="blastWeb";
$sqlPassword="igb123";
...
$peopleDN="ou=people,dc=igb,dc=uiuc,dc=edu";
$groupDN="ou=group,dc=igb,dc=uiuc,dc=edu";
$ssl="0";
$port="389";
$adminGroup="cnrg";


# Configuration for ganglia graph.php code
# $Id: conf.php,v 1.2 2009/02/12 16:10:08 root Exp $
#
