...
?>
<br>
<FORM ACTION="index.php" METHOD = POST NAME="MainBlastFormSimple" id="MainBlastFormSimple" ENCTYPE= "multipart/form-data">
<table>
<tr>
...
<td>
<SELECT name="profile" OnChange="OnSelectProfile(this)">
...
<td>
Saved blast query parameters profiles.
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" name="saveProfileName"><input type="submit" name="saveProfile" value="Save">
</td>
<td>
Save current inputed settings to profile for future use.
</td>
</tr>
...
<td>
<select name="inputp" id="p" size="0" onChange="fill_capital(MainBlastFormSimple.inputp.selectedIndex);">
...
<td>
<select name="inputd" id="d" size="0">
<option value=0 SELECTED></option>
<?php
/*
$dbsArr = $sqlDataBase->query("SELECT id,dbname FROM dbs");
foreach($dbsArr as $id=>$dbInfo)
{
        echo "<option value=".$dbInfo['id'].">".$dbInfo['dbname']."</option>";
}
*/
?>
</select>
...
<td>
<input type="text" name="inpute" id="e" value=10>
</td>
<td>
Expectation value (-e).
<div id="hiddenArea" >
...
<td colspan=3>
<INPUT TYPE="submit" VALUE="Submit Blast Search" name="submitfasta" <?php /*echo ($userid==1 || $userid==13)?"":"disabled=\"disabled\""; */?>>
...
<tr>
<td>
<input type="checkbox" name="params[]" value="m" id="m_box"><td>m</td>
</td>
<td>
<select name="inputm" id="m" size="0">
...
<td>
Alignment view options. If you choose <b>XML Blast output</b> you will also be able to download comma separated values of the parsed results [<a href="csvsample.csv">Sample CSV</a>](-m) 
</td>
</tr>
<tr>
<td>
<input type="checkbox" name="params[]" id="FU_box" value="FU"><td>F</td>
</td>
<td>
<input type="text" name="inputFU" id="FU" value="T">
</td>
<td>
Filter query (-F).
</td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="GU_box" value="GU"><td>G</td>
</td>
<td>
<input type="text" name="inputGU" id="GU" value="-1">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="EU_box" value="EU"><td>E</td>
</td>
<td>
<input type="text" name="inputEU" id="EU" value="-1">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="XU_box" value="XU"><td>X</td>
</td>
<td>
<input type="text" name="inputXU" id="XU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="IU_box" value="IU"><td>I</td>
</td>
<td>
<input type="checkbox" name="inputIU" id="IU" value="T">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="q_box" value="q"><td>q</td>
</td>
<td>
<input type="text" name="inputq" id="q" value="-3">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="r_box" value="r"><td>r</td>
</td>
<td>
<input type="text" name="inputr" id="r" value="1">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="v_box" value="v" checked><td>v</td>
</td>
<td>
<input type="text" name="inputv" id="v" value="3">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="b_box" value="b" checked><td>b</td>
</td>
<td>
<input type="text" name="inputb" id="b" value="3">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="f_box" value="f"><td>f</td>
</td>
<td>
<input type="text" name="inputf" id="f" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="g_box" value="g"><td>g</td>
</td>
<td>
<input type="checkbox" name="inputg" id="g" value="T" checked>
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="QU_box" value="QU"><td>Q</td>
</td>
<td>
<input type="text" name="inputQU" id="QU" value="1">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="DU_box" value="DU"><td>D</td>
</td>
<td>
<input type="text" name="inputDU" id="DU" value="1">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="a_box" value="a" READONLY CHECKED><td>a</td>
</td>
<td>
<input type="text" name="inputa" value="2" id="a" READONLY>
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="JU_box" value="JU"><td>J</td>
</td>
<td>
<input type="checkbox" name="inputJU" id="JU" value="T">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="MU_box" value="MU"><td>M</td>
</td>
<td>
<SELECT name="inputMU" id="MU">
...
<tr>
<td>
<input type="checkbox" name="params[]" id="WU_box" value="WU"><td>W</td>
</td>
<td>
<input type="text" name="inputWU" id="WU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="z_box" value="z"><td>z</td>
</td>
<td>
<input type="text" name="inputz" id="z" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="KU_box" value="KU"><td>K</td>
</td>
<td>
<input type="text" name="inputKU" id="KU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="YU_box" value="YU"><td>Y</td>
</td>
<td>
<input type="text" name="inputYU" id="YU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="SU_box" value="SU"><td>S</td>
</td>
<td>
<input type="text" name="inputSU" id="SU" value="3">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="TU_box" value="TU"><td>T</td>
</td>
<td>
<input type="checkbox" name="inputTU" id="TU" value="T">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="l_box" value="l"><td>l</td>
</td>
<td>
<input type="text" name="inputl" id="l" value=""> 
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="UU_box" value="UU"><td>U</td>
</td>
<td>
<input type="checkbox" name="inputUU" id="UU" value="T">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="y_box" value="y"><td>y</td>
</td>
<td>
<input type="text" name="inputy" id="y" value="0.0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="ZU_box" value="ZU"><td>Z</td>
</td>
<td>
<input type="text" name="inputZU" id="ZU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="RU_box" value="RU" READONLY><td>R</td>
</td>
<td>
<input type="text" name="inputRU" id="RU" READONLY>
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="n_box" value="n"><td>n</td>
</td>
<td>
<input type="checkbox" name="inputn" id="n" value="T">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="LU_box" value="LU"><td>L</td>
</td>
<td>
<input type="text" name="inputLU" id="LU" value="">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="AU_box" value="AU"><td>A</td>
</td>
<td>
<input type="text" name="inputAU" id="AU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="w_box" value="w"><td>w</td>
</td>
<td>
<input type="text" name="inputw" id="w" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="t_box" value="t"><td>t</td>
</td>
<td>
<input type="text" name="inputt" id="t" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="BU_box" value="BU" readonly><td>B</td>
</td>
<td>
<input type="text" name="inputBU" id="BU" value="0">
</td>
<td>
...
<tr>
<td>
<input type="checkbox" name="params[]" id="CU_box" value="CU"><td>C</td>
</td>
<td>
<input type="text" name="inputCU" id="CU" value="D">
</td>
<td>
