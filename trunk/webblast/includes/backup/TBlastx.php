...
<li><a class="progLinks" id="blastpTab" href="Blast2777.html?PROGRAM=blastp&amp;BLAST_PROGRAMS=blastp&amp;PAGE_TYPE=BlastSearch&amp;SHOW_DEFAULTS=on&amp;BLAST_SPEC=&amp;LINK_LOC=blasttab" title="Search a protein databases using a protein query">blastp</a></li>
<li class="tab ">&nbsp</li>
...
<li class="tab-current"><a class="progLinks" id="tblastxTab" href="Blastf0a4.html?PROGRAM=tblastx&amp;BLAST_PROGRAMS=tblastx&amp;PAGE_TYPE=BlastSearch&amp;SHOW_DEFAULTS=on&amp;BLAST_SPEC=&amp;LINK_LOC=blasttab" title="Search translated nucleotide database using a translated nucleotide query">tblastx</a></li> 
<li class="tab-rh">&nbsp</li>
        ...
        <form name="searchForm" action="http://blast.ncbi.nlm.nih.gov/Blast.cgi" enctype="multipart/form-data"  method="post" class="f-wrap-1 all" id="searchForm">
         <div id="progDescr">TBLASTX search translated nucleotide databases using a translated nucleotide query.
         <a href="http://www.ncbi.nlm.nih.gov/blast/producttable.shtml#tblastx" id="progHelp" title="help" target="helpWin" class="help ">more...</a>
...
-->
  ...
  <fieldset>
    ...
    <div class="input all">    
      ...
      <input id="Rhc" name="DBTYPE" type="radio" value="hc"   />
...
<div class="all tblastx" id="optSection">
   ...
   <div class="searchInfo all">        
     ...
     <div class="searchsummary">
         <div class="openNewWin all">
            ...
            <span class="progInfo">Tblastx</span>    
            <span class="progDescr">(Search translated nucleotide databases using a translated nucleotide query) </span>                      
            <br />
...
<option value = "10 1"  >Existence: 10 Extension: 1</option>		                                
      ...
      <fieldset class="all section">
         ...
         <!-- <div class="input all"> -->
         <div class="input all">
               <div class="all"><input type="checkbox" name="FILTER" value="L" id="fil_l" checked="checked" class="reset checkDef opts" defVal="checked"/>
...
<input name="PAGE" type="hidden" id="page" value="Translations"/>
<input name="PROGRAM" type="hidden" value="tblastx" id="program" />
...
<input name="BLAST_PROGRAMS" type="hidden" value="tblastx">

<input type="hidden" id="OhcAbbr" value="Human G+T" />
<input type="hidden" id="OmcAbbr" value="Mouse G+T" />
<input type="hidden" id="dbAbbr" name="DB_ABBR" value="" />
...
<input name="SELECTED_PROG_TYPE" id="selectedProg" type="hidden" value="tblastx"/>
...
<input name="USER_DEFAULT_PROG_TYPE" id="userDefaultprog" type="hidden" value="tblastx"/>
