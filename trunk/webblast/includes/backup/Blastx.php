...
<li class="tab-current"><a  class="progLinks" id="blastxTab" href="Blast0e49.html?PROGRAM=blastx&amp;BLAST_PROGRAMS=blastx&amp;PAGE_TYPE=BlastSearch&amp;SHOW_DEFAULTS=on&amp;BLAST_SPEC=&amp;LINK_LOC=blasttab" title="Search protein databases using a translated nucleotide query">blastx</a></li>                
...
<li class="tab ">&nbsp</li> 
        ...
        <form name="searchForm" action="http://blast.ncbi.nlm.nih.gov/Blast.cgi" enctype="multipart/form-data"  method="post" class="f-wrap-1 all" id="searchForm">
         <div id="progDescr">BLASTX search protein databases using a translated nucleotide query.
         <a href="http://www.ncbi.nlm.nih.gov/blast/producttable.shtml#blastx" id="progHelp" title="help" target="helpWin" class="help ">more...</a>
...
<div class="all blastx" id="optSection">
   ...
   <div class="searchInfo all">        
     ...
     <div class="searchsummary">
         <div class="openNewWin all">
            ...
            <span class="progInfo">Blastx</span>    
            <span class="progDescr">(search protein databases using a translated nucleotide query) </span>                      
            <br />
...
<input name="PROGRAM" type="hidden" value="blastx" id="program" />
...
<input name="UNGAPPED_ALIGNMENT" type="hidden" value="no">
...
<input name="SELECTED_PROG_TYPE" id="selectedProg" type="hidden" value="blastx"/>
...
<input name="USER_DEFAULT_PROG_TYPE" id="userDefaultprog" type="hidden" value="blastx"/>
