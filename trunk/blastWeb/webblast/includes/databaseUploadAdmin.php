...
if(isset($_POST['submitDB']))
{
	if(move_uploaded_file($_FILES['inputi']['tmp_name'], $target_path) || 1)
		...
		echo "<br>";
		Exec::run_in_background("scripts/addDatabase.pl ".$dbName." \"".$dbTitle."\" ".$dbType." ".$dbFile." ".$dbSeqId." ".$dbASNFormat." ".$dbASNMode." ".$dbInSeqEntry." ".$dbCreateIndexes." ".$dbTaxonomicInfo." ".$userId." ".$config_array['config_path']['config_file_path']." > addDatabase.log");	
