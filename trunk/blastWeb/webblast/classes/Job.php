...
class Job
{
	...
	public function CreateJob($newJobName,$loggedUserid,$inputp,$inputd,$inpute,$inputm,$inputFU,$inputGU,$inputEU,$inputXU,$inputIU,$inputq,$inputr,$inputv,$inputb,$inputf,$inputg,$inputQU,$inputDU,$inputa,$inputJU,$inputMU,$inputWU,$inputz,$inputKU,$inputYU,$inputSU,$inputTU,$inputl,$inputUU,$inputy,$inputZU,$inputRU,$inputn,$inputLU,$inputAU,$inputw,$inputt,$inputBU,$inputCU,$paramsEnabled,$chunkSize,$config)
	{
		...
		$sql = "INSERT INTO blast_jobs (name,description,submitDate,userid,blastid,dbid,e,m,FU,GU,EU,XU,IU,q,r,v,b,f,g,QU,DU,a,JU,MU,WU,z,KU,YU,SU,TU,l,UU,y,ZU,RU,n,LU,AU,w,t,BU,CU,paramsenabled,status,chunksize,priority,token) VALUES (\"".$this->jobname."\",\"".$this->description."\",NOW(),".$this->userid.",".$inputp.",".$inputd.",".$inpute.",".$inputm.",\"".$inputFU."\",".$inputGU.",".$inputEU.",".$inputXU.",\"".$inputIU."\",".$inputq.",".$inputr.",".$inputv.",".$inputb.",".$inputf.",\"".$inputg."\",".$inputQU.",".$inputDU.",".$inputa.",\"".$inputJU."\",\"".$inputMU."\",\"".$inputWU."\",".$inputz.",".$inputKU.",".$inputYU.",".$inputSU.",".$inputTU.",\"".$inputl."\",\"".$inputUU."\",".$inputy.",".$inputZU.",\"".$inputRU."\",\"".$inputn."\",\"".$inputLU."\",".$inputAU.",".$inputw.",".$inputt.",".$inputBU.",\"".$inputCU."\",\"".$paramsEnabled."\",".$statusNew.",".$chunkSize.",0,\"".$randomDownloadToken."\")";
	...
	public function LoadJob($id,$config)
	{
	...
	public function SCPJob($host,$path,$username,$password)
	{
		...
		//echo "perl scripts/scp.pl ".$this->finalizePath." ".$host." ".$username." ".$password." ".$path." ".$this->jobid." ".$userNetid;
               	$queryUpdateTransferPid="UPDATE blast_jobs SET transferpid=".$ps.", status=".$statusTransfering."  WHERE id=".$this->jobid;
                $this->sqlDataBase->nonSelectQuery($queryUpdateTransferPid);
	...
	{	
		$ps=Exec::run_in_background($this->perlPath." scripts/fastaParser.pl ".$fastaFilePath." ".$this->jobid." ".$this->chunkSize." ".$this->configFilePath);
		echo $this->perlPath." scripts/fastaParser.pl ".$fastaFilePath." ".$this->jobid." ".$this->chunkSize." ".$this->configFilePath;
	...
	{
                $this->queryPath=$config_array['head_paths']['input_chunks_path'];
                $this->resultsPath=$config_array['head_paths']['output_chunks_path'];
