...
if(isset($_POST['submitScheduler']))
{
	...
	$queryAddSchedule="INSERT INTO schedule (date,nodes,description,nodesmin) VALUES(\"".$date."\",".$_POST['nodes'].",\"".$_POST['description']."\",\"".$_POST['nodesmin']."\")";
...
Max Nodes: <INPUT type="text" name="nodes" VALUE=0 SIZE=3><br>
Min. Nodes: <INPUT type="text" name="nodesmin" VALUE=0 SIZE=3><br>
...
<?php
$querySchedule="SELECT date,nodes,id,description,nodesmin FROM schedule ORDER BY date DESC";
